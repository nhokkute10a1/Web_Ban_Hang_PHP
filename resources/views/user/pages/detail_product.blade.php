@extends('user.master')
@section('description','Đây là trang Detail product')
@section('content')
  ...
  <section id="product">
    ...
    <li class="active">Detail Product</li>
      ...
      <div class="row">
       ...
       <div class="span5">
        <ul class="thumbnails mainimage">
          <li class="span5">
            <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="{!!url('resources/upload/'.$product_detail->HinhAnh)!!}">
              <img src="{!!url('resources/upload/'.$product_detail->HinhAnh)!!}" alt="" title="">
            </a>
          </li>
          <li class="span5">
      ...
      <div class="span7">
        <div class="row">
          <div class="span7">
           <h1 class="productname"><span class="bgnone">{!! $product_detail->TenSanPham !!}</span></h1>
           <div class="productprice">
            <div class="productpageprice">
              <span class="spiral"></span>{!! $product_detail->GiaBan !!}</div>
            </div>
            <ul class="productpagecart">
              <li><a class="cart" href="{!! url('mua-hang',[$product_detail->id,$product_detail->TenSanPham]) !!}">Add to Cart</a>
              </li>
            </ul>
                ...
                <section id="related" class="row">
                  <div class="container">
                    ...
                    <ul class="thumbnails">
                      ...
                      <li class="span3">
                        <a class="prdocutname" href="product.html">{!! $item->TenSanPham !!}</a>
                        <div class="thumbnail">
                          <a href="#"><img alt="" src="{!!url('resources/upload/'.$item->HinhAnh)!!}"></a>
                          <div class="pricetag">
